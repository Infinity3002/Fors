...
class BillControlAdapter : RecyclerView.Adapter<BillControlAdapter.ItemHolder>() {

    private val items = BillMenu.values()
    ...
    class ItemHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: BillMenu) {
            val colorRes = if (item == BillMenu.CLOSE_DEPOSIT) R.color._ec433D else android.R.color.black
    ...
    enum class BillMenu(@StringRes val res: Int, @DrawableRes val resDrawable: Int) {
