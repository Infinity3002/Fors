 ...
 */class BubblesView2 @JvmOverloads constructor(
        context: Context, attrs: AttributeSet? = null, defStyleAttr: Int = 0
) : View(context, attrs, defStyleAttr), TextureView.SurfaceTextureListener {
...
//                    }
//                } finally {
//                    if (canvas != null) view.unlockCanvasAndPost(canvas)
//                }
//                val sleepTime = ticksPS - (System.currentTimeMillis() - startTime)
//                try {
